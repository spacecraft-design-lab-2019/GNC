...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref v2.2.3
  WORKING_DIRECTORY "C:/Users/Ethan/CLionProjects/GNC/cmake_build_debug/_deps/pybind11-src"
...
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 v2.2.3
  WORKING_DIRECTORY "C:/Users/Ethan/CLionProjects/GNC/cmake_build_debug/_deps/pybind11-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/Ethan/CLionProjects/GNC/cmake_build_debug/_deps/pybind11-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/Ethan/CLionProjects/GNC/cmake_build_debug/_deps/pybind11-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
