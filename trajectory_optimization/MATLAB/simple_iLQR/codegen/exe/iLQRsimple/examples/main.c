...
static void argInit_1x399_real_T(double result[399]);
static void argInit_2x1_real_T(double result[2]);
static void argInit_2x2_real_T(double result[4]);
static double argInit_real_T(void);
static void main_iLQRsimple(void);

/* Function Definitions */

/*
 * Arguments    : double result[399]
 * Return Type  : void
 */
static void argInit_1x399_real_T(double result[399])
{
...
static void main_iLQRsimple(void)
{
  ...
  /* Initialize function 'iLQRsimple' input arguments. */
  ...
  /* Call the entry-point 'iLQRsimple'. */
  argInit_1x399_real_T(dv);
  argInit_2x2_real_T(dv1);
  argInit_2x2_real_T(dv2);
  iLQRsimple(x0_tmp, x0_tmp, dv, dv1, argInit_real_T(), dv2, argInit_real_T(),
