###########################################################################
## Makefile generated for MATLAB file/project 'get_magnetic_field'. 
## 
## Makefile     : get_magnetic_field_rtw.mk
## Generated on : Sat Apr 11 23:35:45 2020
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: ./get_magnetic_field.lib
...
PRODUCT_NAME              = get_magnetic_field
MAKEFILE                  = get_magnetic_field_rtw.mk
COMPUTER                  = MACI64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/agatherer/Desktop/GNC/trajectory_optimization/MATLAB/MILQR/codegen/lib/get_magnetic_field
ARCH                      = maci64
RELATIVE_PATH_TO_ANCHOR   = .
COMPILER_COMMAND_FILE     = get_magnetic_field_rtw_comp.rsp
CMD_FILE                  = get_magnetic_field_rtw.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
# Toolchain Name:          GNU Tools for ARM Embedded Processors v7.2.1 | gmake (64-bit Mac)
# Supported Version(s):    
...
PRODUCT = ./get_magnetic_field.lib
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DNULL=0 -D__NO_SYSTEM_INIT -DARM_MATH_CM3=1 -D__NVIC_PRIO_BITS=3 -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=200000 -DMODEL=get_magnetic_field -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
DEFINES_STANDARD = -DMODEL=get_magnetic_field -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/get_magnetic_field_initialize.c $(START_DIR)/get_magnetic_field_terminate.c $(START_DIR)/get_magnetic_field.c $(START_DIR)/get_magnetic_field_emxutil.c
...
OBJS = get_magnetic_field_initialize.o get_magnetic_field_terminate.o get_magnetic_field.o get_magnetic_field_emxutil.o
...
%.o : /Users/agatherer/Desktop/GNC/trajectory_optimization/MATLAB/MILQR/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : /Users/agatherer/Desktop/GNC/trajectory_optimization/MATLAB/MILQR/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : /Users/agatherer/Desktop/GNC/trajectory_optimization/MATLAB/MILQR/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : /Users/agatherer/Desktop/GNC/trajectory_optimization/MATLAB/MILQR/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : /Users/agatherer/Desktop/GNC/trajectory_optimization/MATLAB/MILQR/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
