...
static void initULims(float uLims[6]);
static void initU0(float u0[1497]);
static void initXg(float xg[7]);
static void initX0(float x0[3500]);
static void main_milqr(void);
static void writeToFile(const char* filename, const float x[2004], const int nStates, const int nRows);
...
static void main_milqr(void)
{
  static float x0[3500];
  float xg[7];
  static float u0[1497];
  float uLims[6];
  static float x[3500];
  static float u[1497];
  static float K[8982];
 ...
 */
static void writeToFile(const char* filename, const float x[3500], const int nStates, const int nRows)
{
