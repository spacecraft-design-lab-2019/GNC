...
BEGIN Scenario
    Name		 PyCubed_orbprop_validation

    BEGIN Epoch

        Epoch		 14 Dec 2013 14:18:37.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 14 Dec 2013 14:18:37.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 14 Dec 2013 14:18:37.000000000
        Stop		 21 Dec 2013 14:18:37.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 14 Dec 2013 14:18:37.000000000
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 19 Oct 2019 19:00:00.000000000
                    Stop		 20 Oct 2019 19:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
        ...
        BEGIN Desc
            ...
            END ShortText
            BEGIN LongText
This scenario is used to validate the Python and C++ implementations of the PyCubed orbit propagator and magnetic field models. This uses Tunde's example TLE, see orbit_propagation/orbit_prop_py/orbit.py.
            END LongText
        END Desc
...
<VAR name = "STK_RF_Environment">
    <SCOPE Class = "RFEnvironment">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 14 Dec 2013 14:18:37.000000000
                EndTime		 21 Dec 2013 14:18:37.000000000
                CurrentTime		 14 Dec 2013 15:52:07.000000000
                Direction		 Forward
                UpdateDelta		 10
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Satellite/Orsted_25635
            Satellite/Orsted_25635		
        END Instance
    END References
